        ...
        <div class="col-lg-8 col-lg-offset-2 text-center ">
            ...
            <ul class="items list-unstyled">
              <li *ngFor="#acta of actas">
                <a [routerLink]="['AdminActaView', {id: acta.id}]">Pleno del {{acta.diaSemana}} dia {{acta.dia}} del mes {{acta.mes}} del año {{acta.year}}</a>
              </li>

            </ul>
            <p class="text-center">
                <button class="btn btn-primary" (click)="newActa()">Nueva Acta</button>
...
export class ActaListComponent implements OnInit {
    ...
    newActa() {
      this.router.navigate(['AdminActaNew']);
    }
}