...
## Fase 4 ##
---------------
Este es un Diagrama de clases del código Java del Backend: 
![DiagramadeClases](DiagramadeClases.png "DiagramadeClases")

Estos son un Diagrama de Entidad-Relacion de la BBDD:
![DiagramaEntidad-Relacion1](DiagramaEntidad-Relacion1.png "DiagramaEntidad-Relacion1")
![DiagramaEntidad-Relacion2](DiagramaEntidad-Relacion2.png "DiagramaEntidad-Relacion2")

Este es un enlace al video de la demostracion de la Aplicacion:
[![VideoScreenShot](https://img.youtube.com/vi/N-E1BdyKGUs/0.jpg)](https://www.youtube.com/watch?v=N-E1BdyKGUs&feature=youtu.be)
